bootstrap <- function(site, params, date, offset, delay = 0.1){ 
  ...
  #http://waterservices.usgs.gov/nwis/iv/?format=waterml,1.1&sites=01646500=2014-12-08&endDT=2014-12-09&parameterCd=00060,00065
